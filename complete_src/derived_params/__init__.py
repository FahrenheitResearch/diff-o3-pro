...
from .wind_direction_10m import wind_direction_10m
...
from .fire_weather_index_from_components import fire_weather_index_from_components
...
from .d12_composite import d12_composite
...
_DERIVED_FUNCTIONS = {
    ...
    'fire_weather_index_from_components': fire_weather_index_from_components,
...
class DerivedParameters:
    ...
    wind_direction_10m = staticmethod(wind_direction_10m)
    ...
    fire_weather_index = staticmethod(fire_weather_index)
    ...
    fire_weather_index_from_components = staticmethod(fire_weather_index_from_components)
    ...
    d12_composite = staticmethod(d12_composite)
